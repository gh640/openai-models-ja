...
最も高性能なフラッグシップモデル（複雑・マルチステップなタスク向き）
...
| --- | --- | --- | --- | --- |
| `gpt-4o-2024-08-06` | Structured Outputs をサポートする最新のスナップショット | 128,000 | 16,384 | 20243/10 まで |
| `gpt-4o` | GPT-4o モデル。最も先進的なマルチモーダルフラッグシップモデル。 GPT-4 Trubo よりも安価で高速。現在 `gpt-4o-2024-05-13` を指す。 | 128,000 トークン | 4,096 | 2023/10 まで |
| `gpt-4o-2024-05-13` | 現在 `gpt-4o` が指すモデル | 128,000 トークン | 4,096 | 2023/10 まで |
...
| --- | --- | --- | --- |
| `gpt-4o-mini` | **New**<br>安くて性能の高い小さなモデル。現在 `gpt-4o-mini-2024-07-18` を指す。 | 128,000 トークン | 2023/10 まで |
| `gpt-4o-mini-2024-07-18` | 現在 `gpt-4o-mini` が指すモデル | 128,000 トークン | 2023/10 まで |
